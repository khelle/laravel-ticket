...
},{"./Fx/Fx":5}],5:[function(require,module,exports){
"use strict";
    ...
    $(".ajax-form").submit(function (e) {
        ...
        $.ajax({
            ...
            success: function success(data) {
                ...
                $container.removeClass('alert-danger').removeClass('alert-success');

                if (data.success) {
                    $container.addClass('alert-success').html(data.response);
                } else {
                    $container.addClass('alert-danger').html(data.response);
                }
            },
            error: function error(xhr) {
                ...
                $container.addClass('alert-danger').html(err);
            }
        });
...
},{"./App":4,"bootstrap":1,"jquery":2,"tether":3}]},{},[6]);
